...
pub mod renegotiation_info;//v 0.4.10
...
use crate::extension::renegotiation_info::ExtensionRenegotiationInfo;//v 0.4.10
use anyhow::Result;
...
pub enum ExtensionValue {
    ...
    RenegotiationInfo = 65281,//v 0.4.10
    Unsupported,
}
...
impl From<u16> for ExtensionValue {
    fn from(val: u16) -> Self {
        match val {
            ...
            65281 => ExtensionValue::RenegotiationInfo,//v 0.4.10
...
pub enum Extension {
    ...
    RenegotiationInfo(ExtensionRenegotiationInfo),//v 0.4.10
}
...
impl Extension {
    pub fn extension_value(&self) -> ExtensionValue {
        match self {
            ...
            Extension::RenegotiationInfo(ext) => ext.extension_value(),//v 0.4.10
        }
    }
    ...
    pub fn size(&self) -> usize {
        ...
        len += match self {
            ...
            Extension::RenegotiationInfo(ext) => ext.size(),//v 0.4.10
        };
    ...
    pub fn marshal<W: Write>(&self, writer: &mut W) -> Result<()> {
        ...
        match self {
            ...
            Extension::RenegotiationInfo(ext) => ext.marshal(writer),//v 0.4.10
        }
    }
