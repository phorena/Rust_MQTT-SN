...
pub struct Config {
    ...
    pub client_cas: rustls::RootCertStore, //Update
    ...
    //pub db:Arc<Option<ConnectionDb>>,
}
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            client_cas: rustls::RootCertStore::empty(), //Update
...
pub(crate) type PskCallback = Arc<dyn (Fn(&[u8]) -> Result<Vec<u8>>) + Send + Sync>; //Update
